    ...
    <div className="min-h-screen bg-transparent p-3 sm:p-6 md:p-8 overflow-y-auto scrollbar-hide">
      <div className="max-w-6xl mx-auto">
        <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-8 md:mb-12">
          ...
          <div className="flex flex-wrap gap-2.5">
            ...
            <button
              ...
              className="flex items-center gap-1.5 bg-emerald-600 text-white px-4 sm:px-6 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl hover:bg-emerald-500 transition-all shadow-[0_0_20px_rgba(16,185,129,0.2)] text-[9px] sm:text-[10px] font-black uppercase tracking-widest active:scale-95"
            >
              <Download className="w-3.5 h-3.5" /> Excel
            </button>
            <button
              onClick={exportToPDF}
              className="flex items-center gap-1.5 bg-rose-600 text-white px-4 sm:px-6 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl hover:bg-rose-500 transition-all shadow-[0_0_20px_rgba(225,29,72,0.2)] text-[9px] sm:text-[10px] font-black uppercase tracking-widest active:scale-95"
            >
              <FileText className="w-3.5 h-3.5" /> PDF
            </button>
            <button
              onClick={exportToWord}
              className="flex items-center gap-1.5 bg-blue-600 text-white px-4 sm:px-6 py-3 sm:py-3.5 rounded-xl sm:rounded-2xl hover:bg-blue-500 transition-all shadow-[0_0_20px_rgba(37,99,235,0.2)] text-[9px] sm:text-[10px] font-black uppercase tracking-widest active:scale-95"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 mb-8 md:mb-12">
          <div className="bg-white/5 backdrop-blur-md p-5 sm:p-6 rounded-2xl sm:rounded-[2rem] border border-white/10 flex flex-col justify-center">
            ...
            <span className="text-2xl sm:text-3xl font-black text-white">{filteredOrders.length}</span>
          </div>
          <div className="bg-white/5 backdrop-blur-md p-5 sm:p-6 rounded-2xl sm:rounded-[2rem] border border-white/10 flex flex-col justify-center">
          ...
          <div className="sm:col-span-2 bg-white/5 backdrop-blur-md p-5 sm:p-6 rounded-2xl sm:rounded-[2rem] border border-white/10 flex flex-col justify-between gap-4">
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="flex-1">
                ...
                <input 
                  ...
                  className="w-full p-2.5 bg-white/5 border border-white/5 rounded-lg focus:border-amber-500/50 outline-none text-white font-bold transition-all text-[11px] sm:text-xs"
                />
              </div>
              <div className="flex-1">
        ...
        <div className="bg-white/5 backdrop-blur-xl rounded-2xl sm:rounded-[2.5rem] shadow-2xl border border-white/10 overflow-hidden mb-8 md:mb-12">
          <div className="p-4 sm:p-6 border-b border-white/5 bg-white/5 flex items-center gap-3 sm:gap-4">
            ...
            <input 
              ...
              className="bg-transparent border-none outline-none text-xs sm:text-sm w-full font-black text-white placeholder:text-white/10 uppercase tracking-tight"
            />
          </div>
              ...
              <tbody className="divide-y divide-white/5">
                {filteredOrders.map((order) => (
                  <tr key={order.id} className="hover:bg-white/5 transition-colors group">
                    ...
                    <td className="p-3 sm:p-6">
                      <div className="text-xs font-black text-white uppercase tracking-tight group-hover:text-amber-500 transition-colors break-words line-clamp-2 max-w-[80px] xs:max-w-[120px] sm:max-w-none">{order.customerName}</div>
