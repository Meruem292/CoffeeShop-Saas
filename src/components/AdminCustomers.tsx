...
import { Search, User, Mail, Calendar, Coins, Edit2, X, Check, Trash2, Filter, ArrowUpDown, ShieldAlert, ShieldOff, Clock, Ban, AlertTriangle, ShieldCheck, Maximize2, Camera, MessageSquare, Sparkles } from 'lucide-react';
            ...
            <div className="relative rounded-2xl overflow-hidden border-2 border-amber-500/40 bg-black min-h-[220px] max-h-[55vh] flex items-center justify-center">
              {viewingPhotoProfile.photoURL ? (
                ...
                <div className="p-12 text-center space-y-2">
                  ...
                  <p className="text-[10px] text-slate-500">Customer has not uploaded a profile photo.</p>
                </div>
              )}
            </div>
